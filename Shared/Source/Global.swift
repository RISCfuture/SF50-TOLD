...
extension Defaults.Keys {
    ...
    static let favoriteAirports = Key<Set<String>>("favoriteAirports", default: [], suite: groupDefaults)
    static let recentAirports = Key<Array<String>>("recentAirports", default: [], suite: groupDefaults)
    
    static let payload = Key<Double>("SF50_payload", default: 0.0, suite: groupDefaults) // lbs
