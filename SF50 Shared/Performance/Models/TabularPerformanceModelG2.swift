...
/// Tabular performance model for second-generation SF50 Vision Jet (G2).
///
/// ``TabularPerformanceModelG2`` calculates takeoff and landing performance using
...
final class TabularPerformanceModelG2: BasePerformanceModel {
